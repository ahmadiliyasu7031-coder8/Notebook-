...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Future<void> _contactDeveloper() async {
    await launchUrl(Uri.parse(AppInfo.whatsappContactUrl), mode: LaunchMode.externalApplication);
  }

  Future<void> _joinWhatsAppChannel() async {
    await launchUrl(Uri.parse(AppInfo.whatsappChannelUrl), mode: LaunchMode.externalApplication);
  }
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Column(
          ...
          children: [
            Text(AppInfo.appName, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            Text(AppInfo.appTagline, style: TextStyle(fontSize: 11)),
          ],
        ),
        actions: [
          IconButton(
          ...
          return ListView(
            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    const Text(AppInfo.developerCredit,
                        style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
                    const Text('Student of ${AppInfo.developerSchool}',
